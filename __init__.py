...
# Import distributed upscale video nodes
from .distributed_upscale_video import (
    NODE_CLASS_MAPPINGS as UPSCALE_VIDEO_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as UPSCALE_VIDEO_DISPLAY_NAME_MAPPINGS
)

# Import LTX tiled sampler nodes without making the whole extension depend on LTX.
try:
    from .distributed_ltx_tiled_sampler import (
        NODE_CLASS_MAPPINGS as LTX_TILED_CLASS_MAPPINGS,
        NODE_DISPLAY_NAME_MAPPINGS as LTX_TILED_DISPLAY_NAME_MAPPINGS,
    )
except Exception as e:
    LTX_TILED_CLASS_MAPPINGS = {}
    LTX_TILED_DISPLAY_NAME_MAPPINGS = {}
    debug_log(f"Distributed LTX tiled sampler unavailable: {type(e).__name__}: {e}")
